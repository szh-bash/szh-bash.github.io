...
- 官网客户端登录
  - 优点：
    - 没有 steam 登录的任何缺点
    - 有时（根据汇率）通过淘宝购买 MC card 来充 C 点比较省钱
    - C 点全区通用，可以购买商场道具和其他玩家交换 Tera（游戏币）
    - 有时会有充 C 返利 30% 活动，力度较大
  - 缺点：
    - 平时购买道具没有优惠
    - 银联充值容易限额，需要多用几个账号充值
- steam 登录
  - 优点：
    - 无需注册官网账号；
    - 游戏商场常年有 80% 折扣，配合 steam 倒余额的方式氪金会有较大优惠
  - 缺点：
...
#### X进化暴龙机
- 支持 X 进化必需道具
- 购买或制作 XAI VER II [7D]（有BUG，实际是永久使用）
- Verdandi 分支任务获得永久机
- 商场购买、会员礼包等
#### 数码暴龙机
- 提升特定属性数码兽伤害
